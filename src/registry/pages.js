...
export const PAGES = [
  ...
  },
  {
    ...
    description: 'Write Markdown and preview the rendered HTML output side by side.',
    category: 'text',
    path: '/tools/markdown-preview',
    keywords: ['md', 'html', 'preview', 'render', 'markdown'],
  },
  {
  ...
  },
  {
    id: 'css-minifier',
    title: 'CSS Minifier',
    description: 'Minify CSS to reduce file size for production.',
    category: 'web',
    path: '/tools/css-minifier',
    keywords: ['minify', 'compress', 'css', 'optimize'],
  },
  {
    id: 'html-formatter',
    title: 'HTML Formatter',
    description: 'Prettify and format HTML code with proper indentation.',
    category: 'web',
    path: '/tools/html-formatter',
    keywords: ['format', 'beautify', 'html', 'prettify', 'indent'],
  },
  {
    id: 'json-formatter',
